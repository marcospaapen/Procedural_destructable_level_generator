...
namespace alexcmd{
    public class MeshCut
    {
		...
		public static GameObject[] Cut(GameObject victim, Vector3 anchorPoint, Vector3 normalDirection, Material capMaterial)
        {
			...
			right_HalfMesh.name = "Split Mesh";
			...
			Material[] mats = new Material[] { victim.GetComponent<MeshRenderer>().sharedMaterial, capMaterial };

            GameObject leftSideObj = victim;

			GameObject rightSideObj = new GameObject("piece", typeof(MeshFilter), typeof(MeshRenderer));
